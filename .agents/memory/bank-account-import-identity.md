...
**How to apply:** When matching or creating client bank accounts from statement headers, use the complete normalized account identity and enforce it consistently in concurrency-safe creation paths.